...
namespace HelloGame
{
    public class HelloGame : Game
    {
        ...
        public HelloGame() // window and title
        {
        ...
        protected override void Initialize() // game logic
        {
        ...
        protected override void LoadContent()
        {
            ...
            ballTexture = Content.Load<Texture2D>("basketball");    //Credit for image to Erick Saenz-Gardea in the 580 discord
        }
